...
cred=credentials.Certificate('example-e80da-firebase-adminsdk-eefmn-13a288852a.json')
firebase_admin.initialize_app(cred,{'databaseURL': "https://example-e80da-default-rtdb.firebaseio.com"})
